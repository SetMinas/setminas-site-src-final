	...
	return (
		<section className="py-12 md:py-16 bg-gray-50">
			<div className="container mx-auto px-4">
				<h2 className="section-title">Por que escolher a Setminas?</h2>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
					...
					<div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
						<div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-blue-100 rounded-full flex items-center justify-center">
							<svg
								...
								className="h-7 w-7 sm:h-8 sm:w-8 text-[#0F3B7D]"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor"
							>
						...
						<p className="text-gray-600 text-sm sm:text-base">
							Condições facilitadas e parcelamento direto com a Setminas, sem
							burocracia bancária.
						</p>
					</div>
					...
					<div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
						...
						<p className="text-gray-600 text-sm sm:text-base">
							Loteamentos com toda infraestrutura necessária para você construir
							com tranquilidade.
						</p>
					</div>
					...
					<div className="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center">
						...
						<p className="text-gray-600 text-sm sm:text-base">
							Empreendimentos em áreas com potencial de valorização e qualidade
							de vida.
						</p>
					</div>
				</div>

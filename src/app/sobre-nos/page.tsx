...
export default function ContatoPage() {
	...
	return (
		<main className="min-h-screen bg-gray-50">
			...
			<Player videoName="setminas_video" />
					...
					<div className="space-y-10">
						...
						<div>
							<h2 className="text-2xl font-bold text-gray-800 mb-3">
								Seu Lugar ao Seu Alcance em Minas Gerais
							</h2>
							<p className="text-gray-700 text-lg">
								Nosso propósito é claro: colocar o{" "}
								<strong>seu lugar ao seu alcance</strong>, tornando a aquisição
								da terra própria uma realidade para as famílias mineiras. A
								Setminas existe para abrir as portas do seu futuro, contribuindo
								para o desenvolvimento de Minas Gerais com loteamentos de
								qualidade e oportunidades acessíveis.
							</p>
						</div>
						...
						<div className="flex items-start space-x-4">
							...
							<div>
								<h2 className="text-2xl font-bold text-gray-800 mb-3">
									27 Anos Construindo Confiança no Mercado Mineiro
								</h2>
								<p className="text-gray-700 text-lg mb-4">
									Fundada em 29 de março de 2016, a Setminas é o resultado de
									uma paixão pelo desenvolvimento urbano mineiro que começou
									muito antes. Nosso fundador, Paulo Souza, consolidou 18 anos
									de liderança à frente do Núcleo Minas da Setpar, uma
									referência no setor. Somados aos 9 anos de sucesso da
									Setminas, são <strong>27 anos de dedicação exclusiva</strong>{" "}
									ao mercado de loteamentos em Minas Gerais.
								</p>
								<p className="text-gray-700 text-lg">
									Essa trajetória não é apenas um número. São 27 anos de
									experiência que se traduzem em solidez, profundo conhecimento
									técnico e um entendimento único das necessidades de quem vive
									e investe aqui. Cada metro quadrado entregue pela Setminas
									carrega a segurança e a qualidade que só décadas de expertise
									podem oferecer.
								</p>
							</div>
						</div>
						...
						{/* Missão */}
						<div className="flex items-start space-x-4">
							<div className="bg-blue-100 w-12 h-12 rounded-full mt-1 flex-shrink-0 flex items-center justify-center">
								{" "}
								...
								>
									...
									<path
										fill="currentColor"
										d="M112.32,37.65l-2.39-2.39,1.91-1.91c.79-.79.79-2.06,0-2.85s-2.06-.79-2.85,0l-1.91,1.91-2.39-2.39c-.73-.73-1.91-.73-2.64,0l-5.82,5.82c-.41.41-.61.99-.53,1.57l.76,5.62-28.62,28.62c-.79.79-.79,2.06,0,2.85.39.39.91.59,1.42.59s1.03-.2,1.42-.59l28.62-28.62,5.62.76c.58.08,1.16-.12,1.57-.53l5.82-5.82c.73-.73.73-1.91,0-2.64h0Z"
									/>
								</svg>
							</div>
							<div>
								<h2 className="text-2xl font-bold text-gray-800 mb-3">
									Nossa Missão: Descomplicar a Conquista do Seu Espaço
								</h2>
								<p className="text-gray-700 text-lg mb-4">
									Acreditamos que o acesso à terra deve ser simples e viável.
									Nossa missão é facilitar a conquista do lote próprio para
									todos os perfis de clientes, oferecendo as melhores condições
									do mercado e tornando realidade o conceito:{" "}
								...
								<p className="text-gray-700 text-lg">
									...
									focado em construir uma relação de confiança duradoura.
								</p>
							</div>
						</div>
						...
						<div className="flex items-start space-x-4">
							...
							<div>
								<h2 className="text-2xl font-bold text-gray-800 mb-3">
									Seu Futuro Começa Agora. Fale com a Setminas.
								</h2>
								<p className="text-gray-700 text-lg mb-4">
									Temos orgulho de fazer parte da história de inúmeras famílias
									mineiras. Agora, queremos fazer parte da sua. Não adie mais a
									conquista do seu espaço.
								</p>
								<p className="text-gray-700 text-lg">
									Conheça os loteamentos Setminas e descubra a segurança e a
									facilidade de investir com quem realmente entende de Minas
									Gerais. Entre em contato connosco. Estamos prontos para
									encontrar a solução perfeita para você.
								</p>
							</div>
						</div>
					</div>
			...
			<section className="py-12 md:py-16 bg-gray-100">
				{" "}
				{/* Alterado para bg-gray-100 */}
				<div className="container mx-auto px-4 max-w-4xl">
					{/* Título alinhado à esquerda e com mesmo estilo dos outros títulos de seção */}
					<h2 className="text-2xl font-bold text-gray-800 mb-6">
						Nossos Parceiros: Construindo o Futuro Juntos
					</h2>
					{/* Texto com mesmo estilo dos outros parágrafos de seção */}
					<div className="text-gray-700 text-lg space-y-4">
						<p>
							A Setminas valoriza conexões estratégicas. Cultivamos uma rede
							sólida de empresas parceiras, líderes nos setores imobiliário e de
							construção civil, essenciais para a excelência dos nossos
							projetos.
						</p>
						<p>
							Esta colaboração garante acesso às melhores práticas e
							tecnologias, resultando em loteamentos que superam expectativas.
							Nossos parceiros compartilham nosso compromisso com o
							desenvolvimento sustentável e a satisfação do cliente, assegurando
							eficiência e transparência em cada etapa.
						</p>
						<p>
							A confiança mútua e o alinhamento de valores são a base destas
							alianças, permitindo-nos oferecer soluções completas e fortalecer
							o progresso das comunidades onde atuamos. Juntos, edificamos o
							futuro.
						</p>
					</div>
					...
					<div className="mt-12">
						<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center">
							{[
								{
									nome: "Fort Empreendimentos Imobiliários",
									logoUrl:
										"/images/parceiros/fort_empreendimentos-imobiliarios.svg",
								},
								{
									nome: "Stone Empreendimentos Imobiliários",
									logoUrl: "/images/parceiros/stone.png",
								},
								{
									nome: "Setpar",
									logoUrl: "/images/parceiros/logo_setpar.png",
								},
								{ nome: "MGTop", logoUrl: "/images/parceiros/logo_mgtop.png" },
								{
									nome: "É-Mais",
									logoUrl: "/images/parceiros/logo_e-mais.png",
								},
							].map((parceiro) => (
			...
			<section className="bg-[#0F3B7D] text-white py-12 md:py-16">
				<div className="container mx-auto px-4 text-center">
					<p className="text-lg md:text-xl max-w-3xl mx-auto">
						...
						informações sobre nossos empreendimentos.
					</p>
				</div>
			</section>

			{/* Contact Section */}
			<section id="faleconosco" className="py-12 md:py-16">
							...
							<div className="bg-white p-6 rounded-lg shadow-md h-full">
								...
								<div className="space-y-6">
									...
									<div className="flex items-start">
										...
										<div>
											...
											<p className="text-gray-600 mt-1">(35) 98424-4567</p>
										</div>
									</div>
								...
								<div className="mt-8">
									...
									<div className="flex space-x-4">
										...
										<a
											href="https://www.facebook.com/share/1614P7sjaE/?mibextid=wwXIfr"
											target="_blank"
											rel="noopener noreferrer"
											className="bg-blue-100 p-3 rounded-full hover:bg-blue-200 transition-colors"
										>
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
										...
										<div>
											...
											>
												...
												<option value="Suporte ao cliente">
													Suporte ao cliente
												</option>
